...
| `health_readiness_test.rs`                               | Production-router liveness vs readiness with real Supabase and the owned simulator: independent database and `/models` outages, success-only cache expiry and immediate recovery, missing-schema 503, revoked-key persistence, and default-route circuit override of cached upstream health                                                                                                                                                                                                                                                                                                                                                                                                                |
